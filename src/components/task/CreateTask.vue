  ...
  <form @submit.prevent="submitFormTask">
    ...
    <div class="form-group mb-3">
      <div class="form-group mb-12">
        <button type="reset" class="btn "><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-x-octagon" viewBox="0 0 16 16">
        ...
        <button type="submit" class="btn "> <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-cloud-download" viewBox="0 0 16 16">
